...
const CharacterDetail = ({showDetails, handleClose}) => {
        ...
        <div className="mx-1 my-1 plan-mod" key={modxter.id}>
            <div className="d-flex align-items-center">
                ...
                <div className="px-2 ">
                    ...
                    <p className="fs-6 secondary-color">Amet minim mollit non deserunt</p>
                </div>
            </div>  
        </div>
    ))
        ...
        <>
            <Modal show={showDetails} onHide={handleClose} animation={false} size="sm" className="modal-w">
                <Modal.Header closeButton>
                    <Modal.Title className="fw-bolder">Jane Cooper</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <p className="fs-6 secondary-color">Jane is really a nice person. She’s been living on planet Alpha for the last 10 years.</p>
